...
\title{Dokumentacja <!!!< projektu >!!!> - "Refleks"}
\date{Systemy Wbudowane 2025}
\author{Skład grupy (G02, czwartek 16:15):\\\\
\textbf{Jakub Sikora 251626 (przewodniczący grupy)} \\
...
\subsection{Wykrywalność i reakcja}
W obecnej implementacji wszystkie pozycje mają wartość "Brak", ponieważ w projkecie nie występują:
\begin{itemize}
\item mechanizmy diagnostyczne do automatycznego wykrywania awarii
\item zdefiniowane procedury naprawcze w przypadku wystąpienia problemów
\end{itemize}

\section{Wyniki analizy FMEA}
